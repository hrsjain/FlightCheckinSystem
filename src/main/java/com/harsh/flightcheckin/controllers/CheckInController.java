package com.harsh.flightcheckin.controllers;
...
import com.harsh.flightcheckin.integration.ReservationRestClient;
...
public class CheckInController {
	...
	public String completeCheckIn(@RequestParam("reservationId") Long reservationId, @RequestParam("numberOfBags") int numberOfBags) {
		...
		reservationUpdateRequest.setNoOfBags(numberOfBags);
